...
const FRONT=[
  ...
  kv([
    ...
    ["Conditions","Test conditions. On your table: a copy of the text, a dictionary, one page of your own notes. No pre-written paragraphs or essays. No devices."],
    ["Time","40 minutes, each sitting"],
...
const TASKS=[
{ n:1, band:"PROMPT 1  —  Symbolism and identity",
  ...
  claims:"Paragraph 1 is objects. Paragraph 2 is family, the idea you wrote second in your introduction.",
  choose:null,
  model:[
   ...
   {g:[["PP","In Jimmie’s story"],["p",", "],["S","Mirka"],["V"," gives"],["O"," Oto the necklace"],["p"," so that the sparrow will “recognise Anka’s soul” (ch. 17), which shows that an object can carry a person’s story after they are gone, so the reader sees why Jimmie holds on to it."]],
    i:[["p","In Jimmie’s story, Mirka gives Oto the necklace so that the sparrow will "],["ev","“recognise Anka’s soul” (ch. 17)"],["p",", which "],["verb","shows"],["p"," that "],["idea","an object can carry a person’s story after they are gone"],["p",", so "],["eff","the reader sees why Jimmie holds on to it"],["p","."]]},
   {g:[["S","Subhi’s coin"],["V"," works"],["p"," the same way: "],["S","Queeny"],["V"," tells"],["O"," him"],["p"," that “all [his] treasures … were Ba’s” (ch. 34), which shows that the things Subhi keeps are his only link to a father he has never met, which makes the reader feel how much a small thing can hold."]],
    i:[["p","Subhi’s coin works the same way: Queeny tells him that "],["ev","“all [his] treasures … were Ba’s” (ch. 34)"],["p",", which "],["verb","shows"],["p"," that "],["idea","the things Subhi keeps are his only link to a father he has never met"],["p",", which "],["eff","makes the reader feel how much a small thing can hold"],["p","."]]},
...
{ n:2, band:"PROMPT 2  —  Contrast and freedom",
  ...
  model:[
   ...
   {g:[["S","Subhi"],["V"," admits"],["p"," that “none of us knows what it is like just on the other side of the fences” (ch. 14), which shows that the fence keeps out information as well as people, which makes the reader feel how small Subhi’s world is."]],
    i:[["p","Subhi admits that "],["ev","“none of us knows what it is like just on the other side of the fences” (ch. 14)"],["p",", which "],["verb","shows"],["p"," that "],["idea","the fence keeps out information as well as people"],["p",", which "],["eff","makes the reader feel how small Subhi’s world is"],["p","."]]},
   {g:[["S","Jimmie"],["V"," is"],["O"," the one who brings the outside in"],["p",": “But Jimmie does” (ch. 14) is all Subhi needs to say, which shows that a friend from the other side is his only window on the world, which makes the reader see how much rests on one friendship."]],
    i:[["p","Jimmie is the one who brings the outside in: "],["ev","“But Jimmie does” (ch. 14)"],["p"," is all Subhi needs to say, which "],["verb","shows"],["p"," that "],["idea","a friend from the other side is his only window on the world"],["p",", which "],["eff","makes the reader see how much rests on one friendship"],["p","."]]},
...
{ n:3, band:"PROMPT 3  —  Motif and storytelling",
  ...
  model:[
   ...
   {g:[["S","Maá’s “Listen Now” stories"],["V"," are"],["O"," the thing Subhi remembers"],["p"," as “perfect. Each one” (ch. 5), which shows that a story can hold a family together in a place that gives them nothing, which makes the reader feel what the stories are worth."]],
    i:[["p","Maá’s “Listen Now” stories are the thing Subhi remembers as "],["ev","“perfect. Each one” (ch. 5)"],["p",", which "],["verb","shows"],["p"," that "],["idea","a story can hold a family together in a place that gives them nothing"],["p",", which "],["eff","makes the reader feel what the stories are worth"],["p","."]]},
   {g:[["PP","When Jimmie brings her mother’s book"],["p",", "],["S","Subhi"],["V"," feels"],["O"," “a sort of brave that I haven’t felt since Eli got taken” (ch. 10)"],["p"," before he has read a word, which shows that a story changes how a person feels just by being there, which makes the reader see the book as a kind of company."]],
    i:[["p","When Jimmie brings her mother’s book, Subhi feels "],["ev","“a sort of brave that I haven’t felt since Eli got taken” (ch. 10)"],["p"," before he has read a word, which "],["verb","shows"],["p"," that "],["idea","a story changes how a person feels just by being there"],["p",", which "],["eff","makes the reader see the book as a kind of company"],["p","."]]},
...
function task(t,S,h){
  ...
  return [
    ...
    h.H("Paragraph 2"),
    h.note(t.claims),
    ...(t.choose?[h.P([h.R("☐ "+t.choose[0]+"     ☐ "+t.choose[1])],{after:80})]:[]),
    h.frame(PARA),
    /* page 3: paragraph 3 */
    new Paragraph({pageBreakBefore:true,spacing:{after:0},children:[]}),
    h.H("Paragraph 3"),
...
const ROWS=[
 ["D6EAFC","Ideas",
  ...
  "I can identify parts of the story that relate to key ideas (imprisonment, loneliness, stories)",
