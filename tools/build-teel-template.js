...
const kids=[
  ...
  H("What an essay is"),
  bullet("An essay is a way of organising your thinking so that someone else can follow it."),
  bullet("What is it for? To work out what you think about something, and to show that thinking to a reader who cannot see inside your head."),
  bullet("Sometimes an essay explains. Sometimes it argues. This one argues: it says one thing about the novel and then proves it, one paragraph at a time."),
  ...
  bullet("It uses the big ideas, the events and the characters."),
  bullet("It looks at how the author has written about those things."),
  bullet("The shape: an introduction that says what you think, two to four body paragraphs (one for each reason), and a conclusion that says what it all adds up to."),
  H("The argument"),
